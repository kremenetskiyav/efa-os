...
class PromotionRow:
    ...
    current_boost: str | None; min_boost: str | None; max_boost: str | None
...
def normalize(action: dict, item: dict | None, source_kind: str) -> PromotionRow:
    ...
    return PromotionRow(action.get("id"), action.get("title"), action.get("action_type"), action.get("date_start"), action.get("date_end"), source_kind, item.get("id"), value("price"), value("action_price"), value("max_action_price"), value("current_boost"), value("min_boost"), value("max_boost"))
