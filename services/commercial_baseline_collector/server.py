...
class Handler(BaseHTTPRequestHandler):
    def do_POST(self) -> None:
        ...
        try:
            ...
            self._send(HTTPStatus.OK, collect(self.path, payload))
    ...
    def do_GET(self) -> None:
        self._send(HTTPStatus.OK, {"status": "ok", "service": "commercial-baseline-collector"}) if self.path == "/health" else self._send(HTTPStatus.NOT_FOUND, {"error": "not_found"})
