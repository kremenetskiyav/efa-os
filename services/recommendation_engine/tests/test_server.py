...
from server import ANOMALY_TOOL_PATH, PROMOTION_TOOL_PATH, TOOL_PATH, normalize_transport_arguments
...
class ServerAdapterTests(unittest.TestCase):
    ...
    def test_endpoint_path_is_stable(self) -> None:
        ...
        self.assertEqual(PROMOTION_TOOL_PATH, "/v1/get_promotion_monitoring")
